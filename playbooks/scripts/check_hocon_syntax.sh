...
GRID_DIR=$CONFIG_DIR/substrates/aws/aws-stage1-useast2/coretip1/grid-config/
...
TAGS=DEVTEST_STAGE_FALCON_DP:DEVTEST_XRD_DP
POLICIES=consumer-targetoracle-ciaborg-0.1:consumer-targetsdb-ciaborg-0.1:relay-sourceoracle-ciaborg-0.1
DBCONFIGS=target-oracle-coretipstage:target-sdb-coretipstage:source-oracle-ciaborg

CATCHUP=chs-cfg-1p-syntheticorg
CONSUMER=consumer-cfg-syntheticorg
MANAGEMENT=managementserver-cfg-falcon-syntheticorg
POLICY=policyserver-cfg-falcon-syntheticorg
RELAY=relay-cfg-1P-syntheticorg
GRID=coretip-devtest-staging

PACKAGE_CATCHUP=package-catchup-aws.stage1.useast2.coretip-t.medium
PACKAGE_CONSUMER=package-consumer-aws.stage1.useast2.coretip-t.medium
PACKAGE_MANAGEMENT=package-management-aws.stage1.useast2.coretip-t.medium
PACKAGE_POLICY=package-policy-aws.stage1.useast2.coretip-t.medium
PACKAGE_RELAY=package-relay-aws.stage1.useast2.coretip-t.medium
